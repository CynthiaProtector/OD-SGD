...
#implement the python SGD
# xym implement the SGD in form of Python
@register
...
class ADCASGD(Optimizer):
    ...
    lamda : float, optional
       Scale DC value.
    """
    def __init__(self, momentum=0.0, lamda=1.5, m = 0, **kwargs):
...
# xym add this to define the new local update
@register
class CADCASGD(Optimizer):
    ...
    def __init__(self, momentum = 0.0, lamda=2, m = 0.0, **kwargs):
        super(CADCASGD, self).__init__(**kwargs)
	self.momentum = momentum
        self.weight_previous = {}
        self.lamda = lamda
...
class LASGD(Optimizer):
    ...
    """
    def __init__(self, momentum=0.0, lamda=0.04, **kwargs):
        super(LASGD, self).__init__(**kwargs)
        self.momentum = momentum
        self.weight_previous = {}
        self.lamda = lamda
