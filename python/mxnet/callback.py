...
# xym add this to add execution log to the file Begin
trace = socket.gethostname()
#trace_ = '/PARA/blsc365/perl5/trace/image-task-'+trace+'.txt'
trace_ = '/PARA/blsc365/perl5/trace/image-task.txt'
...
# xym add this to add execution log to the file End
...
class Speedometer(object):
 ...
 #                   logging.info(msg, param.epoch, count, speed, *sum(name_value, ()))
                    #xym add this 8.13
                    logger.info(msg, param.epoch, count, speed, *sum(name_value, ()))
                else:
